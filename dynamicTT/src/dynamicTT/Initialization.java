...
public class Initialization {
	...
	public void readInput() throws IOException{
		...
		classroom.add(room3);
//		ClassRoom room4 = new ClassRoom("LAB2", 20, true,"Computer Science");
//		classroom.add(room4);
...
//		classroom.add(room6);
		...
		professors.add(new Professor(1, "Debtosh", "IR/IRlab/DM"));
		professors.add(new Professor(2, "Sayandip", "P&S"));
		professors.add(new Professor(3, "Saurav", "DS"));
		professors.add(new Professor(4, "Pankaj", "WR"));
		professors.add(new Professor(5, "Dwij", "TOC"));
		professors.add(new Professor(6, "Sarja", "SS"));
		professors.add(new Professor(7, "Fazy", "R"));
		professors.add(new Professor(8, "Navneet", "ML/MLlab"));
		professors.add(new Professor(9, "Bikash", "DAA/UML"));
		professors.add(new Professor(10, "Ankit", "Matlab"));
